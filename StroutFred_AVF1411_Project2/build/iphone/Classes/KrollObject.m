...
//@interface StroutFred_AVF1411_Project2Object : NSObject
//@end

@interface StroutFred_AVF1411_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_AVF1411_Project2Object class]])
		{
			for (NSString *key in [[(StroutFred_AVF1411_Project2Object*)o modules] allKeys])
			{

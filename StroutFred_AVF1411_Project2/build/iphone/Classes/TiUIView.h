...
/**
 Base class for all StroutFred_AVF1411_Project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the StroutFred_AVF1411_Project2 view hierarchy (such as wrapped iOS UIViews) was touched.

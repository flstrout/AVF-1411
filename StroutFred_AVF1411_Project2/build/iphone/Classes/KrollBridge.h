...
@interface StroutFred_AVF1411_Project2Object : KrollCoverageObject {
#else
@interface StroutFred_AVF1411_Project2Object : KrollObject {
#endif
@private
...
extern NSString * StroutFred_AVF1411_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StroutFred_AVF1411_Project2Object *_stroutfred_avf1411_project2;
    KrollObject* console;
	BOOL shutdown;

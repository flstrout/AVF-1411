...
//@interface StroutFred_AVF1411_Project1Object : NSObject
//@end

@interface StroutFred_AVF1411_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_AVF1411_Project1Object class]])
		{
			for (NSString *key in [[(StroutFred_AVF1411_Project1Object*)o modules] allKeys])
			{

...
/**
 The base class for all StroutFred_AVF1411_Project1 modules
 */
...
/**
 StroutFred_AVF1411_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 StroutFred_AVF1411_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 StroutFred_AVF1411_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 StroutFred_AVF1411_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 StroutFred_AVF1411_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */

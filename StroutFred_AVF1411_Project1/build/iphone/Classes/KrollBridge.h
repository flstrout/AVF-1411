...
@interface StroutFred_AVF1411_Project1Object : KrollCoverageObject {
#else
@interface StroutFred_AVF1411_Project1Object : KrollObject {
#endif
@private
...
extern NSString * StroutFred_AVF1411_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StroutFred_AVF1411_Project1Object *_stroutfred_avf1411_project1;
    KrollObject* console;
	BOOL shutdown;

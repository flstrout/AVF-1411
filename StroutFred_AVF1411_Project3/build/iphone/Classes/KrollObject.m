...
//@interface StroutFred_AVF1411_Project3Object : NSObject
//@end

@interface StroutFred_AVF1411_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_AVF1411_Project3Object class]])
		{
			for (NSString *key in [[(StroutFred_AVF1411_Project3Object*)o modules] allKeys])
			{

...
// in simulator we redefine to format for StroutFred_AVF1411_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.stroutfred_avf1411_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stroutfred_avf1411_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStroutFred_AVF1411_Project3NativeItemNone = -1, 
	UIStroutFred_AVF1411_Project3NativeItemSpinner = -2,
	UIStroutFred_AVF1411_Project3NativeItemProgressBar = -3,
	
	UIStroutFred_AVF1411_Project3NativeItemSlider = -4,
	UIStroutFred_AVF1411_Project3NativeItemSwitch = -5,
	UIStroutFred_AVF1411_Project3NativeItemMultiButton = -6,
	UIStroutFred_AVF1411_Project3NativeItemSegmented = -7,
	
	UIStroutFred_AVF1411_Project3NativeItemTextView = -8,
	UIStroutFred_AVF1411_Project3NativeItemTextField = -9,
	UIStroutFred_AVF1411_Project3NativeItemSearchBar = -10,
	
	UIStroutFred_AVF1411_Project3NativeItemPicker = -11,
	UIStroutFred_AVF1411_Project3NativeItemDatePicker = -12,
	
	UIStroutFred_AVF1411_Project3NativeItemInfoLight = -13,
	UIStroutFred_AVF1411_Project3NativeItemInfoDark = -14,
	
	UIStroutFred_AVF1411_Project3NativeItemDisclosure = -15,
	
	UIStroutFred_AVF1411_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StroutFred_AVF1411_Project3 instances of

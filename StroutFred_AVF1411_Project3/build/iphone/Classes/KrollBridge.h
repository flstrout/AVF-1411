...
@interface StroutFred_AVF1411_Project3Object : KrollCoverageObject {
#else
@interface StroutFred_AVF1411_Project3Object : KrollObject {
#endif
@private
...
extern NSString * StroutFred_AVF1411_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StroutFred_AVF1411_Project3Object *_stroutfred_avf1411_project3;
    KrollObject* console;
	BOOL shutdown;
